...
- Ready domain work: M1-002 was accepted in PR #21; M1-003 was selected from Ready with Done dependencies, isolated domain replay ownership, and objective acceptance criteria and checks.
...
No next task is eligible while M1-003 is in review. After acceptance, the task queue must be advanced deliberately before another autonomous run.
