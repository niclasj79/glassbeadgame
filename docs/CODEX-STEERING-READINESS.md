...
Codex may be used as the implementation interface for one supervised task at a time. No next task is eligible until M0-005 and its first budgets are reviewed and merged.
