...
- Ready domain work: M1-003 was accepted in PR #23; M1-004 is fully specified, depends on Done M1-001 through M1-003, owns an isolated state-adapter boundary, and has objective acceptance criteria and checks.
...
Codex may select M1-004 as the first eligible Ready task after this queue-advancement change is reviewed and merged.
